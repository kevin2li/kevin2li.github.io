import{_ as l,W as i,X as p,$ as n,a0 as a,a1 as e,Y as o,Z as t,D as c}from"./framework-805da640.js";const u={},r=n("h1",{id:"简介",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#简介","aria-hidden":"true"},"#"),a(" 简介")],-1),d=n("p",null,"Samba协议是一种文件共享协议，用于在不同操作系统之间共享文件和打印机。它允许Linux和Unix系统与Windows系统之间进行文件和打印机共享。Samba协议是开放源代码的，它的实现是基于SMB/CIFS协议。Samba协议是一种客户端/服务器协议，它使用TCP/IP协议进行通信。Samba协议支持许多不同的操作系统，包括Windows、Linux、Unix、Mac OS等。",-1),m=n("p",null,"自1992年以来，Samba一直为所有使用SMB/CIFS协议的客户端（例如所有版本的DOS和Windows，OS/2，Linux和许多其他客户端）提供安全、稳定、快速的文件和打印服务。",-1),v={href:"https://hub.docker.com/r/dperson/samba",target:"_blank",rel:"noopener noreferrer"},k=n("h1",{id:"方法",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#方法","aria-hidden":"true"},"#"),a(" 方法")],-1),b=n("h2",{id:"使用docker安装",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#使用docker安装","aria-hidden":"true"},"#"),a(" 使用Docker安装")],-1),g=n("br",null,null,-1),y={href:"https://blog.kevin2li.top/post/29",target:"_blank",rel:"noopener noreferrer"},h=n("li",null,[n("p",null,"编写docker compose文件")],-1),f=t(`<div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token function">mkdir</span> <span class="token parameter variable">-p</span> ~/docker-apps/samba
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h2 id="裸机安装" tabindex="-1"><a class="header-anchor" href="#裸机安装" aria-hidden="true">#</a> 裸机安装</h2>`,10),_={href:"https://ubuntu.com/tutorials/install-and-configure-samba#2-installing-samba",target:"_blank",rel:"noopener noreferrer"},x=t(`<ol><li>安装</li></ol><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token function">sudo</span> <span class="token function">apt</span> update
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><ol start="7"><li>连接</li></ol><ul><li>Windows</li></ul><p>路径：<code>\\\\{server-ip}\\{dir}</code></p><p>可以<code>Win+R</code>输入，或者在文件资源管理器地址栏输入。</p><p>为了访问方便，还可以将其加入网络位置。</p><figure><img src="https://minio.kevin2li.top/image-bed/blog/20230521210408.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><figure><img src="https://minio.kevin2li.top/image-bed/blog/20230521210106.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><ul><li>Linux</li></ul><p>路径：<code>smb://{server-ip}/{dir}</code></p><p>打开文件管理器:</p><figure><img src="https://minio.kevin2li.top/image-bed/blog/20230528112248.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><figure><img src="https://minio.kevin2li.top/image-bed/blog/20230528112357.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><p>挂载成功</p><figure><img src="https://minio.kevin2li.top/image-bed/blog/20230528112613.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><ul><li>Mac</li></ul><p>路径：<code>smb://{server-ip}/{dir}</code></p><figure><img src="https://minio.kevin2li.top/image-bed/blog/20230528091742.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><figure><img src="https://minio.kevin2li.top/image-bed/blog/20230528092723.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><figure><img src="https://minio.kevin2li.top/image-bed/blog/20230528092910.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>`,34);function w(S,q){const s=c("ExternalLinkIcon");return i(),p("div",null,[r,d,m,n("p",null,[a("docker镜像： "),n("a",v,[a("https://hub.docker.com/r/dperson/samba"),e(s)])]),o(" more "),k,b,n("ol",null,[n("li",null,[n("p",null,[a("配置docker、docker-compose环境"),g,a(" 参考："),n("a",y,[a("https://blog.kevin2li.top/post/29"),e(s)])])]),h]),f,n("p",null,[a("参考："),n("a",_,[a("https://ubuntu.com/tutorials/install-and-configure-samba#2-installing-samba"),e(s)])]),x])}const M=l(u,[["render",w],["__file","局域网文件共享—Samba使用教程.html.vue"]]);export{M as default};
