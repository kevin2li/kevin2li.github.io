import{_ as e,W as i,X as a,Z as n}from"./framework-805da640.js";const s={},l=n(`<h3 id="显卡管理" tabindex="-1"><a class="header-anchor" href="#显卡管理" aria-hidden="true">#</a> 显卡管理</h3><ul><li><code>nvidia-smi</code></li></ul><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token comment"># Display information on all available GPUs and processes using them:</span>
nvidia-smi
