import{_ as n,W as s,X as a,a0 as e}from"./framework-407a3ac5.js";const i={},t=e(`<h3 id="查看、切换、新建、移动、复制、重命名、删除、链接" tabindex="-1"><a class="header-anchor" href="#查看、切换、新建、移动、复制、重命名、删除、链接" aria-hidden="true">#</a> 查看、切换、新建、移动、复制、重命名、删除、链接</h3><ul><li><code>ls</code></li></ul><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token comment"># List files one per line:</span>
