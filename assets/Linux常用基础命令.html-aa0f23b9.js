import{_ as l,W as t,X as c,Y as o,Z as s,$ as n,a0 as i,a1 as a,D as r}from"./framework-c9619a7b.js";const p={},d=a(`<h1 id="常用命令" tabindex="-1"><a class="header-anchor" href="#常用命令" aria-hidden="true">#</a> 常用命令</h1><h2 id="终端" tabindex="-1"><a class="header-anchor" href="#终端" aria-hidden="true">#</a> 终端</h2><ul><li><code>echo</code></li></ul><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token comment"># Print a text message. Note: quotes are optional:</span>
