import{_ as i,W as l,X as t,Y as c,$ as n,a0 as s,a1 as o,Z as a,D as d}from"./framework-805da640.js";const r={},p=n("h1",{id:"简介",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#简介","aria-hidden":"true"},"#"),s(" 简介")],-1),v=n("p",null,"Git是一个开源的分布式版本控制系统，可以有效、高速地处理从很小到非常大的项目版本管理。它是Linus Torvalds为了帮助管理Linux内核开发而开发的一个开放源码的版本控制软件。Git的作用就是对文件进行版本管理，方便在不同版本进行切换修改，类似文件分不同时间备份让后需要时找回其中一份代替，不过更方便使用。",-1),m=n("p",null,[s("Git文件流： "),n("img",{src:"https://minio.kevin2li.top/image-bed/vanblog/img/5ca15d0a60362cb3f0ad630d0615d394.image.png",alt:"image.png",loading:"lazy"})],-1),u=a(`<h1 id="安装" tabindex="-1"><a class="header-anchor" href="#安装" aria-hidden="true">#</a> 安装</h1><ul><li>Linux系统</li></ul><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token comment"># Ubuntu为例</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>:::info{title=&quot;git reset回退的三种模式区别&quot;} <img src="https://minio.kevin2li.top/image-bed/vanblog/img/a4c1e10cc0f0ecc5fbdb1e8d69136988.image.png" alt="image.png" loading="lazy"></p><p><code>git reset</code> 有三种模式，分别是 <code>--soft</code>、<code>--mixed</code> 和 <code>--hard</code>。它们之间的区别如下：<br><code>--soft</code>：此模式只重置 HEAD 到所选提交。它基本上与 git checkout 相同，但不会创建分离的 HEAD 状态。<br><code>--mixed</code>：默认模式，此模式将 HEAD 重置为所选提交，同时在历史记录和索引中撤消更改。<br><code>--hard</code>：此模式将 HEAD 重置为所选提交，并在历史记录和索引中撤消更改，同时还将工作树重置为所选提交。<br> :::</p><p>:::tip{title=&quot;git reset与git revert的区别&quot;} <code>git reset</code>: 此命令用于通过删除所需提交后的所有更改来将分支的状态重置为先前状态。此命令更改提交历史记录。<br><code>git revert</code>：此命令用于通过创建新的还原提交并保留原始提交来重置到先前状态。此命令不更改提交历史记录。 :::</p><h2 id="标签管理" tabindex="-1"><a class="header-anchor" href="#标签管理" aria-hidden="true">#</a> 标签管理</h2><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token comment"># 设置标签</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,21);function h(f,x){const e=d("ExternalLinkIcon");return l(),t("div",null,[p,v,m,c(" more "),u,n("ul",null,[n("li",null,[s("Windows系统"),b,s(" 可以从"),n("a",k,[s("Git官方网站"),o(e)]),s("下载Git for Windows，也可以安装GitHub Desktop，该安装程序包含图形化和命令行版本的Git")])]),g])}const q=i(r,[["render",h],["__file","Git使用教程.html.vue"]]);export{q as default};
