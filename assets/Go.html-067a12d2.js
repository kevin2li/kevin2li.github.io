import{_ as t,W as p,X as o,$ as n,a0 as s,Z as e,Y as c,a1 as i,D as u}from"./framework-97524b1f.js";const l={},k=n("h1",{id:"简介",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#简介","aria-hidden":"true"},"#"),s(" 简介")],-1),r=n("br",null,null,-1),d={href:"https://gobyexample.com/",target:"_blank",rel:"noopener noreferrer"},v=i(`<h1 id="语法" tabindex="-1"><a class="header-anchor" href="#语法" aria-hidden="true">#</a> 语法</h1><h2 id="hello-world" tabindex="-1"><a class="header-anchor" href="#hello-world" aria-hidden="true">#</a> Hello World</h2><div class="language-go line-numbers-mode" data-ext="go"><pre class="language-go"><code><span class="token keyword">package</span> main
