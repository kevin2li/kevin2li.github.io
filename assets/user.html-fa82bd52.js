import{_ as i,W as l,X as t,$ as s,a0 as n,a1 as o,Z as e,D as c}from"./framework-805da640.js";const d={},r=e(`<h2 id="用户-组-管理" tabindex="-1"><a class="header-anchor" href="#用户-组-管理" aria-hidden="true">#</a> 用户(组)管理</h2><ul><li><code>sudo</code></li></ul><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token comment"># Run a command as the superuser:</span>
