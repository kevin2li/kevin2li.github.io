...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="配置dns-api" tabindex="-1"><a class="header-anchor" href="#配置dns-api" aria-hidden="true">#</a> 配置DNS API</h2><ul><li>腾讯云DNSPOD</li></ul><figure><img src="https://blog.kevin2li.top/static/img/ee3622e1c31dc939cc489fa6c71d4127.image.png" alt="image.png" tabindex="0" loading="lazy"><figcaption>image.png</figcaption></figure><figure><img src="https://blog.kevin2li.top/static/img/e54eb08f69113e8c057f5a20a10463db.image.png" alt="image.png" tabindex="0" loading="lazy"><figcaption>image.png</figcaption></figure><p>记录下申请的密钥的ID和Token值，并执行下面命令存到环境变量中</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token builtin class-name">export</span> <span class="token assign-left variable">DP_Id</span><span class="token operator">=</span><span class="token string">&quot;123456&quot;</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="安装证书" tabindex="-1"><a class="header-anchor" href="#安装证书" aria-hidden="true">#</a> 安装证书</h2><div class="hint-container warning"><p class="hint-container-title">注意</p><p>默认生成的证书都放在安装目录下: ~/.acme.sh/, 请不要直接使用此目录下的文件, 例如: 不要直接让 nginx/apache 的配置文件使用这下面的文件. 这里面的文件都是内部使用, 而且目录结构可能会变化.</p></div><ul><li>nginx</li></ul><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>acme.sh --install-cert <span class="token parameter variable">-d</span> example.com <span class="token punctuation">\\</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="自动续签" tabindex="-1"><a class="header-anchor" href="#自动续签" aria-hidden="true">#</a> 自动续签</h2><p>acme安装成功后会自动为你创建 cronjob, 每天 0:00 点自动检测所有的证书, 如果快过期了, 需要更新, 则会自动更新证书。可通过<code>crontab -l</code>查看定时任务：</p><figure><img src="https://blog.kevin2li.top/static/img/6005f88273a3b369ef0b62d7d6d8eec2.image.png" alt="image.png" tabindex="0" loading="lazy"><figcaption>image.png</figcaption></figure>`,17);function D(P,T){const e=o("ExternalLinkIcon");return l(),c("div",null,[p,u,m,n("p",null,[a("官网："),n("a",v,[a("https://www.nginx.com/"),s(e)]),b,a(" 文档："),n("a",h,[a("https://www.nginx.com/resources/wiki/"),s(e)])]),r(" more "),g,n("blockquote",null,[n("p",null,[a("参考："),n("a",_,[a("https://www.nginx.com/resources/wiki/start/topics/tutorials/install/"),s(e)])])]),k,n("blockquote",null,[n("p",null,[a("参考："),n("a",f,[a("微信：看完这篇还不懂Nginx服务器配置，那我要哭了"),s(e)])])]),x,n("blockquote",null,[w,n("ol",null,[n("li",null,[n("a",y,[a("https://github.com/acmesh-official/acme.sh/wiki/说明"),s(e)])]),n("li",null,[n("a",q,[a("https://github.com/acmesh-official/acme.sh"),s(e)])])])]),n("h2",$,[z,a(),n("a",N,[a("安装acme.sh"),s(e)])]),S])}const L=t(d,[["render",D],["__file","Nginx使用教程.html.vue"]]);export{L as default};
