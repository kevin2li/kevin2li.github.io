import{_ as n,p as s,q as a,a1 as e}from"./framework-5866ffd3.js";const i={},t=e(`<h3 id="查看、切换、新建、移动、复制、重命名、删除、链接" tabindex="-1"><a class="header-anchor" href="#查看、切换、新建、移动、复制、重命名、删除、链接" aria-hidden="true">#</a> 查看、切换、新建、移动、复制、重命名、删除、链接</h3><ul><li><code>ls</code></li></ul><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token comment"># List files one per line:</span>
