...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,44),v={href:"https://www.learncpp.com/cpp-tutorial/why-non-const-global-variables-are-evil/",target:"_blank",rel:"noopener noreferrer"},k=a("<p><strong>non-const global variables</strong> are dangerous is because</p><ol><li>their values can be changed by any function that is called, and there is no easy way for the programmer to know that this will happen.</li><li>Global variables also make your program less modular and less flexible.</li></ol><p><strong>Local variables</strong> are much safer because other functions can not affect them directly.</p><blockquote><p>Use local variables instead of global variables whenever possible. #最佳实践</p></blockquote><blockquote><p>适合使用全局变量的场景: 日志文件</p></blockquote><ul><li><p>全局变量初始化顺序</p><ul><li>静态初始化: In the static initialization phase, global variables with constexpr initializers (including literals) are initialized to those values. Also, global variables without initializers are zero-initialized.</li><li>动态初始化: the gist of it is that global variables with non-constexpr initializers are initialized.</li></ul></li></ul>",6);function m(b,h){const e=c("ExternalLinkIcon");return l(),o("div",null,[p,n("p",null,[s("参考： "),n("a",r,[s("6.2 — User-defined namespaces and the scope resolution operator"),i(e)])]),u,n("ul",null,[n("li",null,[s("全局变量容易导致bug 参考："),n("a",v,[s("why-non-const-global-variables-are-evil"),i(e)])])]),k])}const f=t(d,[["render",m],["__file","C__.html.vue"]]);export{f as default};
