...
目前主流的内网DNS服务器软件主要有[BIND](https://www.isc.org/bind/)和[dnsmasq](https://thekelleys.org.uk/dnsmasq/doc.html)，前者功能强大完备，支通常被用于大型企业，比较重量级，而后者适用于小型网络、家庭网络等场景，比较轻量化,比较适合我目前的需求。因此，本文主要介绍dnsmasq的安装与使用方法。
