...
![image.png](https://blog.kevin2li.top/static/img/b51d4b4f915030ffa4a862d1903b1df5.image.png)

2. 在模拟器中下载安装微信

![image.png](https://blog.kevin2li.top/static/img/57182a041fb947e8216c440499bbe310.image.png)
...
![image.png](https://blog.kevin2li.top/static/img/d50c76fd7a1514a0e55d0ffa9f15e6de.image.png)

开启root权限

![image.png](https://blog.kevin2li.top/static/img/e9534dfca44035253a69dfbe384f82ab.image.png)
...
![image.png](https://blog.kevin2li.top/static/img/c67982d9fe822e37647eeb4cacb9435f.image.png)

- **模拟器端设置**  
打开微信扫一扫，此时模拟器会提示使用“实时截取屏幕”或“开启摄像头”。

![image.png](https://blog.kevin2li.top/static/img/686783144b4462d5476d22161b963fd9.image.png)
...
如图，稍等片刻，聊天记录便可迁移完成。
![image.png](https://blog.kevin2li.top/static/img/974e7a2d20e2bd494224c3b38f7289ea.image.png)
...
![image.png](https://blog.kevin2li.top/static/img/ef1504d73ec00ff74177486f3c20e1cb.image.png)
...
![image.png](https://blog.kevin2li.top/static/img/2e3f6cf416572f043ff9e111af4cf021.image.png)
...
![image.png](https://blog.kevin2li.top/static/img/b456864b35a55caf5c853be4383fd55e.image.png)
...
![image.png](https://blog.kevin2li.top/static/img/aea634a80c8d18ebe38da67c4ddec7cc.image.png)
...
![image.png](https://blog.kevin2li.top/static/img/f5b18222b6602186b10d28f6417ac8bf.image.png)

将解密的密码填写后，就能查看数据库文件。

打开后可以看到很多数据库表，我们的聊天数据记录主要在`message`表中，按照下图示将`message`表导出为csv文件。  

![image.png](https://blog.kevin2li.top/static/img/e83bca9ad40ed9d7adb9526a6a4974ca.image.png)


![image.png](https://blog.kevin2li.top/static/img/c17051630d75d2616dffa594ac13cd54.image.png)

比如我这里最终保存的csv文件为`message_latest.csv`。

![image.png](https://blog.kevin2li.top/static/img/fb98ad03c8337f11d2af326f573d221f.image.png)
...
![image.png](https://blog.kevin2li.top/static/img/dd1d8aba44787ebf434ea24274e89da8.image.png)
...
![image.png](https://blog.kevin2li.top/static/img/07c8fb2fd50a46b402869d1a78148b13.image.png)
...
![image.png](https://blog.kevin2li.top/static/img/8ed74b37d0ed983820ee31bd19a6a1fb.image.png)
