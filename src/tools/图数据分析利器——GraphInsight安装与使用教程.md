---
title: 图数据分析利器——GraphInsight安装与使用教程
category: 工具
tag: [可视化,数据分析]
icon: pen-to-square
order: 1
date: 2022-12-06T07:45:05.494Z
---
# 简介
...
![20221209222008.png](https://blog.kevin2li.top/static/img/e1d908dcdfad59c1bb11a09779625288.20221209222008.png)
...
![](https://blog.kevin2li.top/static/img/17ed8175a8283dcb29bacda6b718d85a.20221209214028.png)
...
![](https://blog.kevin2li.top/static/img/880e135e20286c7558e21a182f1e38e8.20221209220512.png)

:::info 连接TuGraph
在图数据源中选择TuGraph，并依次设置数据库连接地址和账号密码，连接成功后再选择子图，此时页面会重启。  

![](https://blog.kevin2li.top/static/img/3d11e54ea0c2fc08d94868c0c08b838f.20221209221415.png)

在重启后的页面上是没有数据的，需要选择Cypher资产组件，使用cypher语句查询数据后渲染到画布上。  

![](https://blog.kevin2li.top/static/img/8b27d4d9ce636170056f5b38f0929ca8.20221209221746.png)
:::
