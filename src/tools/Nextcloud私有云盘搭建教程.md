...
category: 工具
tag: [私有云盘,nextcloud,webdav]
icon: pen-to-square
order: 1
date: 2022-12-11T13:40:40.512Z
---
#  简介
...
![20221211191728.png](https://blog.kevin2li.top/static/img/6215d4aa3fd52eb1dab01d007ad87d07.20221211191728.png)
...
![](https://blog.kevin2li.top/static/img/5c566def2a4e0606ab8491e9f75a3da3.20221211213702.png)

当然，正常使用过程中从外部访问的情况还是居多，所以还需要在`config/config.php`中设置`trusted_domains`以允许从外部登录，否则就可能会导致下面的错误：

![](https://blog.kevin2li.top/static/img/df9632df9b6e7bf80e25856e0a101e45.20221211220713.png)
...
![](https://blog.kevin2li.top/static/img/a4cf536b46a7485a10f297fefaee92e8.20221211224704.png)

2. windows设置映射网络驱动器  

windows文件资源管理器中，右击"此电脑"，选择"映射网络驱动器"(也可以选择"添加一个网络位置"，步骤类似这里不另做演示)

![](https://blog.kevin2li.top/static/img/5167ea96b62e11eff084bde97490eba8.20221211200157.png)

粘贴上一步中拷贝的webdav地址，注意协议要设置为https，否则会导致映射失败。

![](https://blog.kevin2li.top/static/img/3fd8a1c781364db61e4f2d26e18e25c3.20221211200330.png)
...
![image.png](https://blog.kevin2li.top/static/img/c4d82f649fdb8241fbafe1413a3addf6.image.png)
...
![](https://blog.kevin2li.top/static/img/ee7e360517cf8cd7179d3031632a8505.20221211205725.png)
